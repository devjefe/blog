...
For several months I banged my head against my desk trying to wire up rehypeReact with dangerouslySetInnerHTML to render a code snippet and component demo in my markdon.
...
Whilest browsing the web for large buildings to leap from, I discovered the miracle of Biscardi's gatsby-mdx plugin. But I digress...
...
<img src="../assets/shadowing.png" alt="shadowing" />
